        ...
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="text-xs text-text-muted max-w-xl">
              Daftar lengkap siswa XI Rekayasa Perangkat Lunak SMK Negeri 8.
              Data diambil langsung dari database, dan dapat diperbarui melalui panel admin.
            </p>
          </div>
        ...
        <ScrollReveal>
          ...
          {!loading && !error && students.length === 0 && (
            <div className="glass-card border border-white/5 p-4 text-xs text-text-muted">
              Belum ada data siswa di database. Tambahkan siswa melalui panel admin.
            </div>
          )}
